...
export default function BasicTables() {
  return (
    <>
      <PageMeta
        title="React.js Basic Tables Dashboard | Jaonaichan - Next.js Admin Dashboard Template"
        description="This is React.js Basic Tables Dashboard page for Jaonaichan - React.js Tailwind CSS Admin Dashboard Template"
      />
