...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Jaonaichan - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Jaonaichan - React.js Tailwind CSS Admin Dashboard Template"
      />
