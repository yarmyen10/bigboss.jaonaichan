...
export default function UserMetaCard({ profile, onProfileChange }: Props) {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      const res = await patchProfile({ display_name: displayName });
      if (res.success) {
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="flex items-center justify-center w-20 h-20 overflow-hidden border border-gray-200 rounded-full bg-gray-200 dark:bg-gray-700 dark:border-gray-800">
              {profile.avatarUrl
            ...
            <div className="order-3 xl:order-2">
              ...
              <p className="text-sm text-center text-gray-500 dark:text-gray-400 capitalize xl:text-left">
                {profile.role}
              </p>
              {profile.description && (
